          ...
          <header className="absolute inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
              ...
              <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                { session ? (
                  <>
                    <Link href="/refinement-portal" className="text-sm font-semibold leading-6 text-white bg-indigo-500 py-2 px-4 rounded-xl mr-3">
                      Refinement
                    </Link>
                    <button onClick={() => signOut()} className="text-sm font-semibold leading-6 text-white py-2 px-4 rounded-xl">
                      Logout <span aria-hidden="true">&rarr;</span>
                    </button>
                  </>
                ) : (
                  <button onClick={() => signIn()} className="text-sm font-semibold leading-6 text-white bg-indigo-500 py-2 px-4 rounded-xl">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                  ...
                  <div className="text-center">
                    <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                      <span className="text-indigo-500">Innovais</span> <br/>  Refinement Reimagined
                    </h1>
